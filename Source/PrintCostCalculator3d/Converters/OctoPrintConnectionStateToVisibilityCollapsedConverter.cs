...
namespace PrintCostCalculator3d.Converters
{
    ...
    public sealed class OctoPrintConnectionStateToVisibilityCollapsedConverter : IValueConverter
    {
        #region Properties
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return value is OctoPrintConnectionStates state && VisibilityState.Any(st => st == state) ? Visibility.Visible : Visibility.Collapsed;
        }
