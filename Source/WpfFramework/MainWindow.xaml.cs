...
namespace WpfFramework
{
    ...
    public partial class MainWindow : INotifyPropertyChanged
    {
        ...
        public MainWindow()
        {
            ...
            if (Models.Settings.ConfigurationManager.Current.IsAdmin)
            {
        ...
        protected override async void OnContentRendered(EventArgs e)
        {
            ...
            if (Models.Settings.ConfigurationManager.Current.ShowSettingsResetNoteOnStartup)
            {
       ...
       public ICommand ShowWindowCommand
        ...
        private void ChangeApplicationView(ApplicationViewManager.Name name, bool refresh = false)
        {
            ...
            switch (name)
            {
                ...
                case ApplicationViewManager.Name._3dPrintingMaterial:
                    ...
                    break;
                case ApplicationViewManager.Name._3dPrintingPrinter:
                    ...
                    break;
                case ApplicationViewManager.Name._3dPrintingCalcualtion:
                    ...
                    break;                
                case ApplicationViewManager.Name.EventLog:
